...
* meteogram_gfs.gs shengtaicheng 20220413 117.78 39.16 y
...
* Open the data file
'reinit'
_baseurl = 'http://nomads.ncep.noaa.gov:80/dods/gfs_0p50/'
_dataset = 'gfs'date'/gfs_0p50_00z'
*'open ../grads/gfs.ctl'
...
'set line 0'
'draw recf 'xlo-0.3' 'ylo-0.5' 'xhi+0.3' 'ylo-0.02
*************************************************
...
*******************************************************
*getseries(watrsfc,runoff,1000)
*getseries(soilw100_200cm,sm,1000)
...
getseries(apcpsfc,pt,1000)
getseries(acpcpsfc,pc,1000)
getseries(csnowsfc,csnow,1000)
getseries(cfrzrsfc,cfrzr,1000)
getseries(cicepsfc,cicep,1000)
p = p - 1
'set parea 'panel.p
'set vpage off'
'set grid on'
...
yhi = subwrd(panel.p,4)
ymid = ylo + (yhi-ylo)/2
'set string  5 c 4 90' ; 'draw string 0.35 'ymid' entire atmosphere '
'set string 96 c 4 90' ; 'draw string 0.55 'ymid' `3d`0[total cloud cover [%]]'
if (units = 'e')
...
'set string  1 l  8 0' ; 'draw string 0.10 10.81 `1'name
  ...
  hilat = subwrd(args,4)
  units = subwrd(args,5)
'gxprint meteo_GFS_'name'_'date'_'hilon'_'hilat'.png white'
